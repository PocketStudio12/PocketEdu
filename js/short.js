...
pageTitle.innerHTML=`Short - ${chapterData.chapterName}`;

}

const htmlSnap=await get(
ref(db,`shortQuestions/${subject}/${chapter}`)
);
...
এখনও কোন Short Question যোগ করা হয়নি।
...
// Admin যেভাবে HTML লিখবে
// ঠিক সেভাবেই Render হবে
